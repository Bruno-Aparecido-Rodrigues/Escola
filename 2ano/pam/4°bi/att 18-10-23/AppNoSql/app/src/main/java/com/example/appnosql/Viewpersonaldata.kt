...
class Viewpersonaldata : ComponentActivity() {
...
fun readDataFromDatabase(context: Context) {
    ...
    lateinit var pessoalList: List<CourseModel>
    pessoalList = ArrayList<CourseModel>()

    val dbHandler: DBHandler = DBHandler(context);
    pessoalList = dbHandler.readCourses()!!
    ...
    LazyColumn {
        ...
        itemsIndexed(pessoalList) { index, item ->
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        ...
                        text = pessoalList[index].courseName,
                    ...
                    Text(
                        ...
                        // setting text as the language name
                        // from our model class.
                        text = "Course Tracks : " + pessoalList[index].courseTracks,
                    ...
                    Text(
                        ...
                        // setting text as the language name
                        // from our model class.
                        text = "Course Duration : " + pessoalList[index].courseDuration,
                    ...
                    Text(
                        ...
                        // setting text as the language name
                        // from our model class.
                        text = "Description : " + pessoalList[index].courseDescription,
