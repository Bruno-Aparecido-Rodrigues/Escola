...
fun addDataToDatabase(
    ...
    val pessoalnome = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalendereco = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalbairro = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalCEP = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalcidade = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalestado = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoaltelefone = remember {
        mutableStateOf(TextFieldValue())
    }
    val pessoalcelular = remember {
        mutableStateOf(TextFieldValue())
    }
    ...
    Column(
        ...
        TextField(
            ...
            value = pessoalnome.value,
            // on below line we are adding on value change for text field.
            onValueChange = { pessoalnome.value = it },
        ...
        TextField(
            // on below line we are specifying value for our email text field.
            value = pessoalendereco.value,
            // on below line we are adding on value change for text field.
            onValueChange = { pessoalendereco.value = it },
            // on below line we are adding place holder as text as "Enter your email"
        ...
        // on below line we are creating a text field.
        TextField(
            value = pessoalbairro.value,
            onValueChange = { pessoalbairro.value = it },
        ...
        TextField(
            value = pessoalCEP.value,
            onValueChange = { pessoalCEP.value = it },
        ...
        TextField(
            value = pessoalcidade.value,
            onValueChange = { pessoalcidade.value = it },
        ...
        TextField(
            value = pessoalestado.value,
            onValueChange = { pessoalestado.value = it },
        ...
        TextField(
            value = pessoaltelefone.value,
            onValueChange = { pessoaltelefone.value = it },
        ...
        TextField(
            value = pessoalcelular.value,
            onValueChange = { pessoalcelular.value = it },
        ...
        Button(onClick = {
            dbHandler.addNewperson(
                pessoalnome.value.text,
                pessoalendereco.value.text,
                pessoalbairro.value.text,
                pessoalCEP.value.text,
                pessoalcidade.value.text,
                pessoalestado.value.text,
                pessoaltelefone.value.text,
                pessoalcelular.value.text
            )
            Toast.makeText(context, "Cadastro realizado", Toast.LENGTH_SHORT).show()
        }) {
            // on below line adding a text for our button.
            Text(text = "Adicionar ao banco", color = Color.White)
        }
        ...
        Button(onClick = {
            val i = Intent(context, Viewpersonaldata::class.java)
            context.startActivity(i)
        }) {
            // on below line adding a text for our button.
            Text(text = "Exibir dados do banco", color = Color.White)
        }
    }
}
