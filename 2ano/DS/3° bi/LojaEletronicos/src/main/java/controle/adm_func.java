...
public class adm_func extends JFrame {
    ...
    public adm_func()
    {
        ...
        //icones dos botões
        String icones[]={"imagens/search.png","imagens/write.png","imagens/delete.png","imagens/alter.png","imagens/new.png","imagens/next.png","imagens/previous.png","imagens/exit.png","imagens/return.png"};
        ...
        rNavegacao.setBounds(540,-5,550,100);
        ...
        prox.setBounds(628,140,30,30);
        anterior.setBounds(573,140,30,30);
        prim.setBounds(573,180,85,20);
        ultimo.setBounds(573,210,85,20);
        novoreg.setBounds(573,60,30,30);
        gravar.setBounds(628,60,30,30);
        alterar.setBounds(573,100,30,30);
        excluir.setBounds(628,100,30,30);
        tpesquisa.setBounds(350,525,250,21);
        pesquisar.setBounds(605,525,30,20);
        sair.setBounds(90,560,30,30);
        ...
        tblClientes.setBounds(50,320,730,200);
        scp_tabela.setBounds(50,320,630,200);
    ...
    public void preencherTabela() //metodo para popular as caixas da tabela
    {
       ...
       tblClientes.getColumnModel().getColumn(5).setPreferredWidth(170);
