...
public class admnistrar extends JFrame

{
...

    {
        ...
        ImageIcon icone = new ImageIcon("src/imagens/paw_icon.png");
        ...
        String icones[]={"src/imagens/search.png","src/imagens/write.png","src/imagens/delete.png","src/imagens/alter.png","src/imagens/new.png","src/imagens/next.png","src/imagens/previous.png","src/imagens/exit.png","src/imagens/return.png","src/imagens/back.png","src/imagens/primeiro.png","src/imagens/ultimo.png"};
        ...
        rEspecie.setBounds(50,70,100,20);

        rRaca.setBounds(50,130,100,20);

        rData.setBounds(50,100,150,20);

        rCor.setBounds(50,190,150,20);

        rSexo.setBounds(50,160,150,20);
        ...
        tnome.setBounds(135,40,180,20);

        tespecie.setBounds(110,70,100,20);

        traca.setBounds(85,130,93,20);

        data.setBounds(180,100,70,20);

        tcor.setBounds(165,190,90,20);

        tsexo.setBounds(90,160,70,20);

        prox.setBounds(613,110,40,40);

        anterior.setBounds(563,110,40,40);

        prim.setBounds(513,110,40,40);

        ultimo.setBounds(663,110,40,40);

        novoreg.setBounds(513,165,40,40);

        gravar.setBounds(563,165,40,40);

        alterar.setBounds(613,165,40,40);

        excluir.setBounds(663,165,40,40);
        ...
        rNum.setForeground(Color.black);

        rNome.setForeground(Color.black);

        rEspecie.setForeground(Color.black);

        rRaca.setForeground(Color.black);

        rData.setForeground(Color.black);

        rCor.setForeground(Color.black);

        rSexo.setForeground(Color.black);

        rPesquisa.setForeground(Color.black);
