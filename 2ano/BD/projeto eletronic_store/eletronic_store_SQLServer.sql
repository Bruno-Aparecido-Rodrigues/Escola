...
cpf_cli float NOT NULL,
email_cli varchar(50) NOT NULL,
dtnasc_cli date NOT NULL,
);

INSERT INTO dadoscliente (nome_cli, cpf_cli, email_cli, dtnasc_cli)
VALUES ('Andrei Nunes Pereira', 11958734127, 'andrei@gmail.com', '2006-03-12');

INSERT INTO dadoscliente (nome_cli, cpf_cli, email_cli, dtnasc_cli)
VALUES ('Endrigo Gustavo', 53958492127, 'genshinplayer@gmail.com', '2006-04-06');
...
INSERT INTO notafiscal (cod_cli,cod_func,dtcompra_nota)
VALUES (1,1,'2023-08-28');

INSERT INTO notafiscal (cod_cli,cod_func,dtcompra_nota)
VALUES (2,3,'2023-09-23');
...
INSERT INTO itensnfiscal (cod_nota, cod_pro,qtcompra)
VALUES (1,1,2);

select * from notafiscal;
select * from produto;
select * from itensnfiscal;
