...
DELETE Envio WHERE Regiao is null
DELETE Envio WHERE NomeNavio like 'Chop-suey Chinese'
DELETE Envio WHERE Frete>100
DELETE FROM Envio
-----------------------------tabela territorio---------------------------------
...
DELETE Territorio WHERE  Cod_Regiao=3
DELETE Territorio WHERE  Territoriodescricao like 'New York'
DELETE Territorio WHERE  Cod_Territorio>90000
